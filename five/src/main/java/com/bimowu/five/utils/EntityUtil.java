...
public class EntityUtil {
    ...
    private final String bean_path = "E:\\develop\\bimowu\\five\\src\\main\\java";

    private final String mapper_path = "E:\\develop\\bimowu\\five\\src\\main\\java\\com\\bimowu\\five\\dao";

    private final String xml_path = "E:\\develop\\bimowu\\five\\src\\main\\resources\\mapping";// xml路径

    private final String model_package = "com.bimowu.five.model";// model的包所在

    private final String dao_package = "com.bimowu.five.dao";// dao的包所在
    ...
    private final String url = "jdbc:mysql:///" + moduleName  + "?characterEncoding=utf8";
    ...
    private void buildMapper(List<String> columns, List<String> types) throws IOException {
        ...
        bw.newLine();
        bw.write("import com.bimowu.five.utils.bean.CommonQueryBean;");
        bw.newLine();
        bw.newLine();
